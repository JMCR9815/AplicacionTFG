...
public class Delete_Dialog_Proveedores extends AppCompatDialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_layout_proveedores, null);
        editTextDelete = view.findViewById(R.id.editTextArtProveedor);
        builder.setView(view).setTitle("Borrar").setNegativeButton("Cancel", new DialogInterface.OnClickListener() {
            ...
            private void deleteArticulo(String string) {
                Call<Void> delete = carneService.deleteProveedor(Integer.parseInt(editTextDelete.getText().toString()));
